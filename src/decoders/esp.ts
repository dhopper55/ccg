...
function decodeEarlyLTDKoreaEShort(serial: string): DecodeResult {
...
function decodeEdwardsEDNewFormat(serial: string): DecodeResult {
...
function decodeJapanVintage7Digit(serial: string): DecodeResult {
...
function decodeLTDIndonesiaIWI(serial: string): DecodeResult {
...
function decodeLTDNumeric9Digit(serial: string): DecodeResult {
...
function decodeLTDIndonesiaWT(serial: string): DecodeResult {
  const yearDigits = serial.substring(2, 4);
  const weekDigits = serial.substring(4, 6);
  const sequence = serial.substring(6);
  const year = 2000 + parseInt(yearDigits, 10);
...
function decodeESPKisoCustomSpecial(serial: string): DecodeResult {
  const yearDigits = serial.substring(1, 3);
  const year = 2000 + parseInt(yearDigits, 10);
...
function decodeELPrefixEarlyEII(serial: string): DecodeResult {
...
function decodeLTDKoreaWShort(serial: string): DecodeResult {
