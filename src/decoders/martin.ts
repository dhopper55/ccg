...
const MARTIN_RANGES: [number, number][] = [
...
export function decodeMartin(serial: string): DecodeResult {
...
function decodeStandardMartin(serialNum: number, serial: string): DecodeResult {
...
function decodeSigmaMartin(serial: string): DecodeResult {
  const info: GuitarInfo = {
    brand: 'Martin (Sigma)',
    serialNumber: serial,
    year: '1981-1982',
...
function decodePreSerialMartin(serial: string): DecodeResult {
