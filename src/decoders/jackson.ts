...
function decodeJapanMijSevenPrefixSevenDigit(serial: string): DecodeResult {
  const sequence = parseInt(serial, 10);
...
function decodeJapanEightPrefixSevenDigit(serial: string): DecodeResult {
  const yearDigits = serial.substring(0, 2);
...
function decodeJapanNinePrefixNineDigit(serial: string): DecodeResult {
  const yearDigits = serial.substring(0, 2);
  const possibleYear = 1900 + parseInt(yearDigits, 10);
  const sequence = parseInt(serial.substring(2), 10);
...
function decodeJapanChushinCPrefix(serial: string): DecodeResult {
  const sequence = serial.substring(1);
  const sequenceNumber = parseInt(sequence, 10);
...
function decodeIndiaXN(serial: string): DecodeResult {
...
function decodeChinaGWC(serial: string): DecodeResult {
...
function decodeChinaGWJ(serial: string): DecodeResult {
  const yearDigits = serial.substring(3, 5);
  const sequence = serial.substring(5);
  const year = 2000 + parseInt(yearDigits, 10);
  const sequenceNumber = parseInt(sequence, 10);
...
function decodeISJIndonesiaSamick(serial: string): DecodeResult {
  const yearDigits = serial.substring(3, 5);
...
function decodeIndiaNJHJL(serial: string): DecodeResult {
