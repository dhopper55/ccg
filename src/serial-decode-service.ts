...
type DecoderFn = (serial: string) => DecodeResult;

const DECODER_MAP: Record<string, DecoderFn> = {
  gibson: decodeGibson,
...
export interface ServerDecodeResult extends DecodeResult {
  normalizedBrand?: string;
  correctedSerial?: string;
}
...
export function decodeSerialForBackend(brandInput: string, serialInput: string): ServerDecodeResult {
  ...
  let correctedSerial: string | undefined;
...
function buildRetrySerials(serial: string, normalizedBrand: string): string[] {
