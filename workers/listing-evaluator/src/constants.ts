export const SITEMAP_STATIC_URLS = [
  ...
  { loc: '/denver-area-music-gear-consignment/', changefreq: 'monthly', priority: '0.8' },
...
export const DEFAULT_SALE_DESCRIPTION_POSTFIX = `📍 Local pickup in Englewood, CO
...
export const SHOP_COUPONS = new Map<string, { amountOffCents: number }>([
...
export const CCG_NUMBER_MIN = 100000;
export const CCG_NUMBER_MAX = 999999;
export const CCG_NUMBER_ATTEMPTS = 25;
export const INVENTORY_MAX_IMAGES = 20;
export const ALLOWED_IMAGE_TYPES = ['image/jpeg', 'image/png', 'image/webp', 'image/gif'];
export const SERIAL_DECODE_HOURLY_LIMIT = 60;
export const SERIAL_DECODE_DUPLICATE_WINDOW_HOURS = 24;
export const SERIAL_AI_HOURLY_LIMIT = 20;
export const ACTIVITY_BASE_URL = 'https://www.coalcreekguitars.com';
...
export const ACTIVITY_EVENT_TYPE_SEEDS: Array<{ key: ActivityEventKey; templateText: string; iconKey: string }> = [
...
export const BRAND_ACTIVITY_META: Record<string, { label: string; decoderSlug: string; logoFile: string }> = {
...
export const SINGLE_FIELD_KEYS = [
  'category',
  'brand',
  'model',
  'finish',
