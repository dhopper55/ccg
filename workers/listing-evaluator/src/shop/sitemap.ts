...
export function handleRobotsTxt(): Response {
  return new Response(
    [
      ...
      'Disallow: /e3827649-7c18-4383-b925-3c3277810ff8.html',
      'Disallow: /67f35a0c-5090-495e-80fb-de996f0f2807.html',
      'Disallow: /a14305d1-821b-439c-a16c-8996782bc768.html',
      `Disallow: ${SHOP_BASE_PATH}/cart`,
      `Disallow: ${SHOP_BASE_PATH}/?category=`,
      '',
