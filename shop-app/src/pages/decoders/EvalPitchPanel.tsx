      ...
      >
        ...
        <Box component="p" sx={{ m: 0, mt: 0.5, typography: 'body2', lineHeight: 1.9 }}>
          <Box component="span" sx={{ color: 'text.secondary' }}>
            Get Reverb comps, dealer offers &amp; a ready-to-post listing &mdash; just $19.99
          </Box>
        </Box>
        <Box sx={{ mt: 1 }}>
          <Box
        ...
        {/* Social proof */}
        <Typography variant="body2" sx={{ color: 'text.secondary', mt: 2, mb: 0.75 }}>
          We have checked many other {brand} sales recently so you don't have to.
        </Typography>
        <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>
          100's of highly detailed reports delivered — usually ready in minutes.
        </Typography>
