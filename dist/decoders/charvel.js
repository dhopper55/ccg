...
// Japanese MIJ neck plate: 5-digit (roughly 1986-1989)
function decodeJapanNeckPlate(serial) {
    const num = parseInt(serial, 10);
    const info = {
        brand: 'Charvel',
        serialNumber: serial,
...
// Japanese MIJ/IMC-era neck plate: 7-digit sequential
function decodeJapanNeckPlate7Digit(serial) {
    const num = parseInt(serial, 10);
    const info = {
        brand: 'Charvel',
        serialNumber: serial,
...
// Numeric 8-digit modern import-style format: YYMM + sequence
function decodeNumeric8Modern(serial) {
...
function decodeCharvelUCChina(normalized, cleaned) {
...
function decodeIMCAddressMark(serial) {
    return {
        success: true,
        info: {
            brand: 'Charvel',
