...
export function decodeEpiphone(serial) {
    ...
    if (numeric8digitMatch) {
        return decode8DigitNumericImport(numeric8digitMatch[1], numeric8digitMatch[2], numeric8digitMatch[3], numeric8digitMatch[4], normalized);
    }
...
const LETTER_MONTH_NAMES = {
    'A': 'January', 'B': 'February', 'C': 'March', 'D': 'April',
    'E': 'May', 'F': 'June', 'G': 'July', 'H': 'August',
    'I': 'September', 'J': 'October', 'K': 'November', 'L': 'December',
};
function decodeLetterMonthFormat(factory, yearStr, monthLetter, sequence, serial) {
...
function decode8DigitNumericImport(yearDigit, batchDigit, monthStr, seqStr, serial) {
    const year = `199${yearDigit}`;
...
function decodeEpiphoneUSAFormat(y1, ddd, y2, rrrr, serial) {
