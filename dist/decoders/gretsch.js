...
function decodeJapanRevival(serial) {
...
function decodeBaldwinHyphen(serial) {
...
function tryBaldwinDateCode(serial) {
...
function decodePreBaldwinSequential(serial) {
...
function decodeIndonesiaWildwoodIWA(serial) {
...
function decodeIndonesiaSamickIS(serial) {
