...
function decodeNormanBPrefix(serial) {
...
function decodeAmbiguous7DigitCase(serial) {
    const info = {
        brand: GODIN_FAMILY_BRAND_LABEL,
        serialNumber: serial,
...
function decodePreModern(serial) {
    const info = {
        brand: GODIN_FAMILY_BRAND_LABEL,
        serialNumber: serial,
...
function decodeNumericFallback(serial) {
    const info = {
        brand: GODIN_FAMILY_BRAND_LABEL,
        serialNumber: serial,
